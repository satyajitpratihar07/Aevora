  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-center gap-3">
      ...
      <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900/90 text-white text-xs font-bold shadow-lg border border-slate-700 backdrop-blur-md animate-bounce">
        ...
        <span>Ask Aevora Assistant</span>
      </div>

      {/* Main Floating Pulse Button */}
      <button
        onClick={onClick}
        className="group relative w-14 h-14 rounded-full bg-gradient-to-tr from-sky-600 via-blue-600 to-indigo-600 text-white flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-300 border-2 border-white/40 cursor-pointer"
        title="Open Aevora Assistant"
      >
